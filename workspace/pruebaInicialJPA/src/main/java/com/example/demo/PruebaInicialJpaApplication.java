...
public class PruebaInicialJpaApplication {
	
	private static final Logger logger = LoggerFactory.getLogger(PruebaInicialJpaApplication.class)

	public static void main(String[] args) {
		SpringApplication.run(PruebaInicialJpaApplication.class, args);
	}
    ...
    public CommandLineRunner demo(RepositorioCliente repositorio) {
        return (args) -> {
            ...
            logger.info("--------------------------------------------");
            repositorio.findByLastApellido("Bauer").forEach(bauer -> {
